const   languageNav = {
    zh:{
     ...
     ja: {
          ...
          11: "三、購入申請を始めます",
          12: "1.KYC（身分の認証）の審査を成功に通過した後（申請を提出した1-3 の営業日内）、先行販売ページに入り、点击【直ちに買いだめする】をクリックします。",
          13: "購入申請リンク：",
          14: "2.ポップアップしたページ中で自分が必要とする買いだめの部数を記入し、システムは自動的にお支払い必要とするUSDT限定額を計算します。情報が間違いないことを確認した後、閲読し、且つチェックを確認します ",
          15: "【次のステップ】をクリックします。",
          16: "初ラウンドでAECOを先行販売する総量は1500部で、AECOの単価は 0.12 USDTで、1部から発売し、1部は20000 AECOと等しく、つまり、2400 USDTを支払う必要があり、これに従い、類推します。",
          ...
          24: "六、公式カスタマーサービス",
          25: "若しあなたは如果您对AECOの購入申請、取引に対して、疑問が存在したり、本プラットフォームの発展に対して、建設意見や提案があったりすると、",
     ...
     ko: {
          ...
          15: "【다음】을 클릭합니다.",
          16: "최초 예판AECO총량은1500부이며，AECO단가는 0.12 USDT ，1부 부터 판매하며，1부는20000 AECO에 해당합니다. 즉 2400 USDT지불이 필요하며 같은 방법으로 유추합니다.",
          17: "IV. 정보 확인 및 지불 완성",
